...
bitflags::bitflags! {
    ...
    pub struct Features: u64 {
        ...
        /// Enables texture atomic fetch add, and, xor, or, min, and max for R32Uint and R32Sint textures.
        ///
        /// Supported platforms:
        /// - Vulkan
        /// - DX12 (with SM 5+)
...
impl TextureFormat {
    ...
    pub fn guaranteed_format_features(&self, device_features: Features) -> TextureFormatFeatures {
        ...
        let atomic = all_flags | TextureUsages::SHADER_ATOMIC;
        ...
        let (
            ...
            Self::R32Uint =>              (        noaa,     atomic),
            Self::R32Sint =>              (        noaa,     atomic),
...
bitflags::bitflags! {
    ...
    pub struct TextureUsages: u32 {
        ...
        // Native Features:
        //
        /// Allows a texture to be used with image atomics. Requires [`Features::TEXTURE_ATOMIC`] or [`Features::TEXTURE_INT64_ATOMIC`] for 64 bit textures
...
pub enum StorageTextureAccess {
    ...
    /// ```
    ReadWrite,
    /// The texture can be both read and written in the shader vias atomics and must be annotated
