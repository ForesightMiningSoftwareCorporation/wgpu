            ...
            None => {
                ...
                let expr = if let Some(fun) = conv::map_relational_fun(function.name) {
                    ...
                    match function.name {
                        ...
                        "imageAtomicMin" | "imageAtomicMax" | "imageAtomicAdd"
                        | "imageAtomicAnd" | "imageAtomicOr" | "imageAtomicXor" => {
                            ...
                            let stmt = crate::Statement::ImageAtomic {
                                ...
                                fun: match function.name {
                                    ...
                                    "imageAtomicAdd" => crate::AtomicFunction::Add,
                                    "imageAtomicAnd" => crate::AtomicFunction::And,
                                    "imageAtomicOr" => crate::AtomicFunction::InclusiveOr,
                                    "imageAtomicXor" => crate::AtomicFunction::ExclusiveOr,
                                    _ => unreachable!(),
                                },
                                value,
                            };
