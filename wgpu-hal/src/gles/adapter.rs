...
impl crate::Adapter for super::Adapter {
    ...
    unsafe fn texture_format_capabilities(
        ...
        let image_atomic = feature_fn(wgt::Features::TEXTURE_ATOMIC, Tfc::SHADER_ATOMIC);
        let image_64_atomic = feature_fn(wgt::Features::TEXTURE_INT64_ATOMIC, Tfc::SHADER_ATOMIC);
